...
namespace DataAccess.Migrations
{
    ...
    partial class EcoClothesContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.PaymentSubscription", b =>
                {
                    ...
                    b.HasIndex(new[] { "PaymentId" }, "paymentId")
                        .IsUnique()
                        .HasDatabaseName("paymentId1");

                    b.HasIndex(new[] { "SubscriptionId" }, "subscriptionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("DataAccess.Models.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "SubscriptionId" }, "subscriptionId")
                        .IsUnique()
                        .HasDatabaseName("subscriptionId1");
            ...
            modelBuilder.Entity("DataAccess.Models.Payment", b =>
                {
                    b.HasOne("DataAccess.Models.Order", "PaymentNavigation")
                        .WithOne("Payment")
                        .HasForeignKey("DataAccess.Models.Payment", "PaymentId")
                        .HasPrincipalKey("DataAccess.Models.Order", "PaymentId")
                        .IsRequired()
                        .HasConstraintName("Payment_ibfk_3");

                    b.HasOne("DataAccess.Models.PaymentSubscription", "Payment1")
                        .WithOne("Payment")
                        .HasForeignKey("DataAccess.Models.Payment", "PaymentId")
                        .HasPrincipalKey("DataAccess.Models.PaymentSubscription", "PaymentId")
                        .IsRequired()
            ...
            modelBuilder.Entity("DataAccess.Models.PaymentSubscription", b =>
                {
                    b.HasOne("DataAccess.Models.Subscription", "Subscription")
                        ...
                        .HasForeignKey("DataAccess.Models.PaymentSubscription", "SubscriptionId")
            ...
            modelBuilder.Entity("DataAccess.Models.Product", b =>
                {
                    b.HasOne("DataAccess.Models.OrderItem", "ProductNavigation")
                        .WithOne("Product")
                        .HasForeignKey("DataAccess.Models.Product", "ProductId")
                        .HasPrincipalKey("DataAccess.Models.OrderItem", "ProductId")
                        .IsRequired()
            ...
            modelBuilder.Entity("DataAccess.Models.Subscription", b =>
                {
                    b.HasOne("DataAccess.Models.User", "SubscriptionNavigation")
                        .WithOne("Subscription")
                        .HasForeignKey("DataAccess.Models.Subscription", "SubscriptionId")
                        .HasPrincipalKey("DataAccess.Models.User", "SubscriptionId")
                        .IsRequired()
